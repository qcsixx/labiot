...
<head>
    ...
    <title>Verifikasi Email - Lab IoT Vokasi UB</title>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    ...
                                    <td style="padding-left: 20px;">
                                        ...
                                        <p style="color: rgba(255,255,255,0.9); margin: 5px 0 0; font-size: 14px; font-weight: 500;">Verifikasi Email</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td style="background-color: #ffffff; padding: 40px 30px;">
                            ...
                            <div style="margin-bottom: 25px; color: #444;">
                                <p style="margin: 0 0 15px; font-size: 15px; line-height: 1.7;">
                                    Terima kasih telah mendaftar di Sistem Peminjaman Lab IoT Vokasi UB. Untuk melanjutkan proses pendaftaran, silakan verifikasi alamat email Anda dengan mengklik tombol di bawah:
                                </p>
</div>
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td align="center" style="padding: 30px 0;">
                                        <!--[if mso]>
                                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $verificationUrl }}" style="height:45px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#0B3B65">
                                            <w:anchorlock/>
                                            <center style="color:#ffffff;font-family:sans-serif;font-size:16px;font-weight:bold;">Verifikasi Email</center>
                                        </v:roundrect>
                                        <![endif]-->
                                        <a href="{{ $verificationUrl }}" target="_blank" style="display: inline-block; background-color: #0B3B65; color: #ffffff; font-weight: 600; padding: 13px 30px; border-radius: 6px; text-decoration: none; font-size: 16px; line-height: 1.4; text-align: center; transition: all 0.2s ease; box-shadow: 0 3px 12px rgba(11, 59, 101, 0.2); -webkit-appearance: none; mso-hide: all;">Verifikasi Email</a>
                                    </td>
                                </tr>
                            </table>
                            
                            <p style="margin: 15px 0 5px; font-size: 14px; color: #555;">Jika tombol di atas tidak berfungsi, Anda dapat menyalin dan menempelkan URL berikut ke browser Anda:</p>
        ...
        {{ $verificationUrl }}
                            ...
                            <div style="background-color: #fffaf2; border: 1px solid #feebc8; border-left: 4px solid #f6ad55; border-radius: 6px; padding: 16px; margin: 25px 0;">
                                <p style="margin: 0 0 8px; font-size: 14px; color: #744210;">
                                    <strong style="font-weight: 600;">Perhatian:</strong> Link verifikasi ini akan kedaluwarsa dalam 60 menit. Jika link telah kedaluwarsa, silakan login dan minta link verifikasi baru.
                                </p>
                                <p style="margin: 0; font-size: 14px; color: #744210;">
                                    Jika Anda tidak melakukan pendaftaran ini, Anda dapat mengabaikan email ini.
                                </p>
</div>
